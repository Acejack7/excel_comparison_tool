...
def create_report_file(full_content_marked, cur_dir, lang_code):
    ...
    teal_bg = wb_report.add_format()
    teal_bg.set_pattern(1)
    teal_bg.set_bg_color('#40a2c9')

    ws.write('A1', 'Source', teal_bg)
    ws.write('B1', 'Translation', teal_bg)
    ws.write('C1', 'Review', teal_bg)
    ws.write('D1', 'Changed?', teal_bg)
    ws.write('E1', 'Trans File', teal_bg)
    ws.write('F1', 'Trans Sheet', teal_bg)
    ws.write('G1', 'Trans Row', teal_bg)
    ws.write('H1', 'Review File', teal_bg)
    ws.write('I1', 'Review Sheet', teal_bg)
    ws.write('J1', 'Review Row', teal_bg)
